...
Este directorio contiene referencias a artículos científicos importantes en Inteligencia Artificial.
...
## 🌟 Papers Históricos y Fundacionales
...
## 💡 Cómo Leer Papers de IA

### Estrategia de Lectura
1. **Primera pasada (5-10 min)**
   - Lee título, abstract, conclusiones
   - Mira figuras y tablas
   - Decide si vale la pena leer completo

2. **Segunda pasada (1 hora)**
   - Lee introducción y related work
   - Entiende metodología a alto nivel
   - Ignora detalles matemáticos complejos
   - Anota preguntas

3. **Tercera pasada (4-5 horas)**
   - Lee en profundidad
   - Entiende cada ecuación
   - Identifica fortalezas y debilidades
   - Considera reimplementación
...
- **Lee código**: Si está disponible

## 🔍 Herramientas para Papers
...
- **Semantic Scholar**: Búsqueda inteligente
- **arXiv Vanity**: Renderiza papers en HTML
- **Scholarcy**: Summarización automática
- **Notion**: Notas y organización

### Seguimiento
- **Twitter académico**: Muchos autores comparten trabajos
- **ArXiv Sanity**: Curated feed de arXiv
- **Papers With Code Newsletter**: Resumen semanal
- **Reddit r/MachineLearning**: Discusión de papers

## 📖 Recursos para Aprender a Leer Papers
